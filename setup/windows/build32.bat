move ..\..\bin\EndlessWallsDelphi.exe ..\..\bin\EndlessWalls.exe
...
del ..\..\data\developer.config

SET VERSION=%BUILDTAG:~1%
"C:\Program Files (x86)\NSIS\makensis.exe" /DVERSION=%VERSION% /DGAMELANG=ru /DUPPERLANG=RU EndlessWalls.nsi
"C:\Program Files (x86)\NSIS\makensis.exe" /DVERSION=%VERSION% /DGAMELANG=en /DUPPERLANG=EN EndlessWalls.nsi
